...
export default function Home() {
  return <main>
    ...
    <section className="hero" id="top">
      ...
      <div className="heroBottom"><p className="intro">안녕하세요, MOON KIM입니다.<br />브랜드의 감각을 발견하고, 디지털 경험과 시스템으로 완성하는 디자이너입니다.</p><a className="roundLink" href="#about" aria-label="소개 보기">↓</a></div>
    ...
    <footer id="contact"><p className="sectionLabel">04 / Let&apos;s connect</p><h2>Good work starts<br />with a good conversation.</h2><div className="footerRow"><p>새로운 브랜드, 더 나은 경험, 재미있는 실험을 함께 이야기해요.</p><a href="https://github.com/designer-moon" target="_blank" rel="noreferrer">GitHub ↗</a></div><div className="signature">MOON KIM</div></footer>
  </main>;
}
